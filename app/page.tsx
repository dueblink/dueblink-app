...
export default function LandingPage() {
  ...
  // Dynamic limit: 15 for logged-in users, 5 for non-logged-in/guests
  const maxLimit = user ? 15 : 5;
  const limitReached = reminderCount >= maxLimit;
  ...
  const scrollToSection = (id: string) => {
    ...
    // Use requestAnimationFrame to ensure the mobile DOM has repainted after menu closure
    requestAnimationFrame(() => {
      setTimeout(() => {
        ...
        if (element) {
          const yOffset = -90; // accounts for sticky header height offset
  ...
  return (
    <div className="min-h-screen bg-white text-[#0F172A] antialiased selection:bg-[#20B8BE]/20" suppressHydrationWarning={true}>
      ...
      <nav className="border-b border-slate-100 bg-white/90 backdrop-blur-md sticky top-0 z-50 transition-all duration-300 shadow-3xs" suppressHydrationWarning={true}>
          ...
          <div className="hidden md:flex items-center gap-8" suppressHydrationWarning={true}>
            <div className="flex items-center gap-6 text-sm font-bold" suppressHydrationWarning={true}>
              ...
              <motion.button 
                ...
                className={`relative py-2 px-3 transition-colors duration-200 cursor-pointer font-bold group ${activeSection === 'features' && pathname === '/' ? 'text-[#245B92]' : 'text-slate-600 hover:text-[#245B92]'}`}
                suppressHydrationWarning={true}
              >
              ...
              <motion.button 
                ...
                className={`relative py-2 px-3 transition-colors duration-200 cursor-pointer font-bold group ${activeSection === 'faq' && pathname === '/' ? 'text-[#245B92]' : 'text-slate-600 hover:text-[#245B92]'}`}
                suppressHydrationWarning={true}
              >
              ...
              <motion.button 
                ...
                className={`relative py-2 px-3 transition-colors duration-200 cursor-pointer font-bold group ${pathname === '/contact' ? 'text-[#245B92]' : 'text-slate-600 hover:text-[#245B92]'}`}
                suppressHydrationWarning={true}
              >
              ...
              {pathname === '/login' ? (
                ...
                <div className="flex items-center gap-4">
                  ...
                  <div className="relative group py-2">
                    <motion.button whileHover={{ scale: 1.02 }} whileTap={{ scale: 0.98 }} transition={{ duration: 0.2 }} className={`flex items-center gap-1.5 text-sm font-bold transition cursor-pointer px-3 py-2 rounded-xl ${pathname === '/account' ? 'bg-[#245B92]/10 text-[#245B92]' : 'text-slate-700 hover:text-[#245B92] hover:bg-slate-50'}`} suppressHydrationWarning={true}>
  	  ...
  	  <div className="pt-2 sm:pt-4 flex flex-col items-center justify-center gap-4 px-4" suppressHydrationWarning={true}>
  	    <motion.button 
  	      whileHover={{ scale: 1.02 }}
  	  	  ...
  	  	  suppressHydrationWarning={true}
  	  	>
  	  	  {user ? 'Open Dashboard' : 'Try 5 AI Reminders Free'}
  	    </motion.button>
  	...
  	<div className="max-w-6xl mx-auto text-center space-y-10 sm:space-y-12" suppressHydrationWarning={true}>
  	  ...
  	  >
  		...
  		<motion.div 
  		  ...
  		  whileHover={{ y: -3 }}
  		  className="bg-white border border-slate-200/60 rounded-2xl p-6 shadow-3xs flex flex-col justify-between space-y-4 hover:shadow-xs transition-shadow duration-200"
  		  suppressHydrationWarning={true}
  		>
  	  ...
  	  <div className="bg-white border border-slate-200 rounded-3xl p-6 sm:p-14 shadow-xl grid grid-cols-1 lg:grid-cols-2 gap-12 items-center" suppressHydrationWarning={true}>
  		...
  		<div className="pt-2" suppressHydrationWarning={true}>
  		  <motion.button 
  		    ...
  		    suppressHydrationWarning={true}
  		  >
  		    {!user ? 'Create Free Account' : !isPro ? 'Upgrade to Pro' : 'Open AI Recovery Assistant'} <ArrowRight size={16} />
  		  </motion.button>
  		</div>
  	    </div>
  	...
  	<div className="max-w-6xl mx-auto text-center space-y-10" suppressHydrationWarning={true}>
  	  ...
  	  <div className="max-w-5xl mx-auto space-y-6" suppressHydrationWarning={true}>
  		...
  		>
  		  ...
  		  <span>{user ? 'Go to Dashboard' : 'Generate Reminder'}</span>
  	...
  	<div className="max-w-7xl mx-auto text-center space-y-10" suppressHydrationWarning={true}>
  	  <div className="space-y-2" suppressHydrationWarning={true}>
  	    <div className="text-3xl sm:text-4xl select-none mb-1" suppressHydrationWarning={true}>🤖</div>
  	    <h2 className="text-2xl sm:text-4xl font-black text-[#0F172A] tracking-tight" suppressHydrationWarning={true}>
  	      {user ? 'Generate AI Reminder — Member Edition (15 Monthly Free)' : 'Generate Your First AI Reminder — Free'}
  	    </h2>
  	...
  	<div className="max-w-6xl mx-auto text-center space-y-20 sm:space-y-24" suppressHydrationWarning={true}>
  	  ...
  	  <div className="space-y-12" suppressHydrationWarning={true}>
  		...
  		<motion.div 
  		  ...
  		  whileHover={{ y: -3 }}
  		  className="bg-white border border-slate-100 p-8 rounded-3xl shadow-3xs text-center flex flex-col items-center space-y-4 hover:border-blue-100 transition-all duration-200"
  		  suppressHydrationWarning={true}
  		>
  	...
  	<div className="max-w-5xl mx-auto text-center space-y-12" suppressHydrationWarning={true}>
  	  ...
  	  >
  		...
  		suppressHydrationWarning={true}
  	      >
  		{user ? (isPro ? 'Current Plan ✓' : 'Upgrade to Pro') : 'Upgrade to Pro'}
  	      </button>
  	    </motion.div>
  	  </motion.div>
  	</div>
  	...
  	onClick={() => {
  	  ...
  	  className="fixed bottom-6 right-6 z-[90] bg-[#0F172A] text-white p-3 rounded-full shadow-lg hover:bg-[#245B92] hover:scale-105 transition-all duration-200 cursor-pointer border border-white/10"
  	  aria-label="Toggle scroll position"
  	  suppressHydrationWarning={true}
  	>
  	  <ChevronDown className={`w-5 h-5 transition-transform duration-300 ${isAtTop ? '' : 'rotate-180'}`} suppressHydrationWarning={true} />
  	</button>
