...
export default function SeasonalLandingAccent() {
  ...
  const DiwaliIcon = () => (
    ...
    >
      ...
      <path
        d="M17 3
           C13.8 7 14.2 9.7 16.1 11.5
           C17.5 10.3 18.5 8.8 18 6.5
           C21.2 9.7 21.7 13.3 19.3 15.4
           C17.2 17.2 13.5 15.8 13.5 12.8
           C10.9 16.1 12.2 20 17 20
           C21.7 20 23 16.2 20.7 12.9
           C23.2 9.5 20.7 5.2 17 3Z"
        fill="#F59E0B"
      />
      ...
      <path
        d="M17 9
           C15.6 11 15.6 13 17 14.3
           C18.4 13.2 18.6 11.4 17 9Z"
        fill="#FFF7ED"
      />
      ...
      <path
        d="M7 20
           C9.5 25.2 13.1 28 17 28
           C20.9 28 24.5 25.2 27 20
           C21.2 22.1 12.8 22.1 7 20Z"
        fill="#D97706"
      />

      <path
        d="M10 22.1
           C13.8 23.1 20.2 23.1 24 22.1"
        fill="none"
        stroke="#FBBF24"
        strokeWidth="1.2"
        strokeLinecap="round"
  ...
  const accentClass =
    isIndiaEvent
      ? 'from-[#FF9933] via-slate-300 to-[#138808]'
      : isEid
        ? 'from-[#245B92] via-[#20B8BE] to-[#245B92]'
        : isDiwali
          ? 'from-amber-400 via-orange-300 to-amber-400'
          : isHoli
            ? 'from-pink-400 via-purple-400 to-orange-400'
            : 'from-red-400 via-slate-200 to-emerald-500';
  ...
  return (
    ...
    >
      <div className="relative inline-flex items-center gap-2.5 rounded-full border border-slate-200/80 bg-white/90 px-3.5 py-2 shadow-sm backdrop-blur-sm">

        {/* Festival icon */}

        <motion.span
          className={`flex h-7 w-7 items-center justify-center shrink-0 rounded-lg ${iconBackground}`}
          animate={{
            y: [0, -1, 0],
          }}
          transition={{
        ...
        <span
          className={`absolute bottom-0 left-5 right-5 h-[1.5px] rounded-full bg-gradient-to-r ${accentClass}`}
        />
      </div>
    </motion.div>
  );
